...
const HELP = `Recover and verify a published IPSEITY module from chain data:
  node tools/modules-recover.mjs --rpc HTTPS_RPC --chain CHAIN_ID --registry ADDRESS --release RELEASE_ID --output NEW_DIR
