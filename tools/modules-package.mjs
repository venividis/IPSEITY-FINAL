...
const HELP = `Package an immutable IPSEITY module without deploying it:
  node tools/modules-package.mjs --input APP_DIR --metadata OPTIONS.json --output NEW_DIR
  node tools/modules-package.mjs --legacy-html APP.html --metadata OPTIONS.json --output NEW_DIR
