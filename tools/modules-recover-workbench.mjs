...
export async function recoverWorkbench({request,chainId,workbench,tokenId,block,expectedHash,expectedCodeHash}) {
  ...
  if(tokenId!==undefined) {
    ...
    if(tokenContext.collection!==collection||tokenContext.stateStore!==stateStore)throw Error('IPSEITY service binding mismatch');
  }
