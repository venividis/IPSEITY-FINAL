...
import { keccak256, sha256, toUtf8Bytes } from '../vendor/ethers.min.js';

// IPSEITY stores these opaque bytes under its own module namespace. The ANIMA
// packet schemas below remain unchanged so previously exported journals open.
export const IPSEITY_JOURNAL_MODULE_KEY = keccak256(toUtf8Bytes('ipseity.personal-journal/1'));
export const IPSEITY_JOURNAL_STATE_SCHEMA = sha256(toUtf8Bytes('ipseity.journal-entry/1'));
